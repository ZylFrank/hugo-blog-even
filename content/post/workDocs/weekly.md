...
1. 总结自交系纯度鉴定时的引物选择问题，编写代码和文档
1. 学习使用prisma，nexus结合graphql搭建graphql服务端项目。并实现基本的CRUD操作和分页查询等功能
1. 处理种质资源库系统的部署，修改一些bug
1. 制作TSTP项目的详细设计说明书，以便著作权的申请
1. TSTP项目添加Muscle对齐功能
